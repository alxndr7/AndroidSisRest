 ...
 */
public class GridAdapterDefault extends BaseAdapter {
    ...
    private int cod;
    private boolean flagEliminar,flagCheck = true;

    public GridAdapterDefault(Context c, mComensal[] items) {
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.default_item, null, false);
       ...
       // ImageView image = (ImageView) view.findViewById(R.id.imagen);
        ...
        // Seteando Nombre
        TextView name = (TextView) view.findViewById(R.id.nombreComensal);
        name.setText(item.getcNomCom() + " " + item.getcApeCom());
        CheckBox check = (CheckBox) view.findViewById(R.id.checkBoxDefault);
        ...
        if(selected_position==position)
        {
            ...
            flagCheck = false;
            Constantes.setCodComUsu(item.getnCodUsuCom());
            Log.d(TAG,"CONSTANTE CODIGO COMENSAL:" + Constantes.getCodComUsu());
        }
        else
        {
           // Log.d(TAG,"CHECK ELSE:" + position);
            check.setChecked(false);
        }

        if(item.getcDefault().compareTo("T") == 0 && flagCheck){
            check.setChecked(true);
            Constantes.setCodComUsu(item.getnCodUsuCom());
        }

        //check.setText(custList.get(position).getCircle_name_cir());
